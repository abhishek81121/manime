...
class ChapterListSearch {
  ...
  Future<dynamic> searchChapter(String mangaId, String offset) async {
    ...
    Response response = await dio.get(
        'https://api.mangadex.org/manga/$mangaId/feed?order[chapter]=asc&limit=499&includeFuturePublishAt=0&offset=$offset&translatedLanguage[]=en&includeExternalUrl=0');
